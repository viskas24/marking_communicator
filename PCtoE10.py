...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
    s.connect((HOST, PORT))
#    s.sendall(b'\x02\x00\x35\x53\x00\x0D'+b'TEST'+b'\x00\x00\x00\x00\x00\x00\x00\x00\x02\x03')    # load file from e10
#    data: bytes = s.recv(1024)
#    print('Received', repr(data))      # test message from e10
#    data = data[17:77]
#    print('File', repr(data))
...
#   length fo filename =11. unused letter = \x00
